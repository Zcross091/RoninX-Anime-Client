...
const Map<String, ExclusiveSchemeData> exclusiveSchemes = {
  ...
  'ronin': ExclusiveSchemeData(
    name: 'Ronin',
    description: 'Dark base with striking crimson and gold accents',
    light: FlexSchemeColor(
      primary: Color(0xFFE63462),
      primaryContainer: Color(0xFFFFD4DF),
      secondary: Color(0xFFF2C14E),
      secondaryContainer: Color(0xFFFFF2D4),
      tertiary: Color(0xFF151519),
      tertiaryContainer: Color(0xFF33333D),
    ),
    dark: FlexSchemeColor(
      primary: Color(0xFFE63462),
      primaryContainer: Color(0xFF5E1326),
      secondary: Color(0xFFF2C14E),
      secondaryContainer: Color(0xFF6B531C),
      tertiary: Color(0xFF151519),
      tertiaryContainer: Color(0xFF0B0B0F),
    ),
  ),
};
